...
<div
  className="profile-card w-[300px] h-[350px] rounded-md shadow-xl overflow-hidden z-[100] relative cursor-pointer snap-start shrink-0 bg-slate-100 flex flex-col items-center justify-center gap-3 transition-all duration-300 group"
>
  <div
  ...
  >
    ...
    >
      ...
      <div className="absolute bg-[#58b0e0] z-10 size-[92%] w-full group-hover:size-[1%] group-hover:transition-all group-hover:duration-300 transition-all duration-300 delay-700 group-hover:delay-0">
      <img className='w-[100px] h-[100px] rounded-full m-auto overflow-hidden z-11 ' src={sliceUser?.photoURL} alt='user'/>
      </div>
    </div>
  </div>
  <div className="headings pt-5 *:text-center *:leading-4">
    <p className="text-xl font-serif font-semibold text-[#434955]">{sliceUser?.displayName}</p>
    <p className="text-sm pt-2 font-semibold text-[#434955]">DEVELOPER</p>
  </div>
